...
export const genererVoyage = async (params) => {
    const { destination, budget, duree, style, adultes, enfants, animaux, depart, dates } = params;
...
Prends en compte le budget, le style, la durée, le nombre de voyageurs et les animaux.
